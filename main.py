...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {"role": "system", "content": """ou are a smart AI Bot. Your task is to answer the user's query based on information from three relevant database collections:
            ...
            Attempt to search in the relevant database collection that matches the user's query. If no relevant information is found in the database, perform an internal search. 
